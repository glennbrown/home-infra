...
This role configures and optionally mounts drives on Linux systems by managing entries in the `/etc/fstab` file.
...
| state | State of the mount (present, mounted, etc) | No | 'mounted' |
